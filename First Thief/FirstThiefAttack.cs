...
public class FirstThiefAttack : MonoBehaviour
{
    public AudioSource attackSound;
    // Enemy_Attack
    public int attackDamage = 20; // Damage dealt to the player by the enemy's attack

    public Vector3 attackOffset; // Offset for the attack's origin
    public float attackRange = 1f; // Range of the enemy's attack
